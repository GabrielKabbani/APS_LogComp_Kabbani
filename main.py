...
reserved_words = ["imprima", "leia", "enquanto", "caso", "senao", "var", "i32", "String", "fn", "retorne"]
func_table = {}
...
class Parser: 
    ...
    def parse_statement(token):
        ...
        elif token.next.type == "retorne":

            token.selectNext()

            return Return('retorne', Parser.parse_rel_expression(token))
